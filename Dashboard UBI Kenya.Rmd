...
observeEvent(input$kenyamap_marker_click, {
   #leafletProxy("kenyamap", session) %>%
   #  removeMarker(input$map1_marker_click$id)
  renderText({input$kenyamap_marker_click})
  })
...
renderText({
  ...
  #  return (NULL)
  #}
  #paste0("Information for :", df %>% 
  #         filter(latitude == click$lat, longitude == click$lon))
  #paste0("inputMap: ", input$map_click)
})
...
renderPlot({
  ...
  # ##
# ggplot(aes(x = cons_food, y = ..count..,
#                 fill = as.factor(treat))) +
#   geom_histogram(position = "dodge", col = "black") +
#   theme_wsj() + 
#   labs(x = "$", y = "Density", fill = "Treatment")
})
